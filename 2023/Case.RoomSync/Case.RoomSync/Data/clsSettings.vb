...
#Region "Friend Members - Shared Parameter File and Parameters"
        ...
        ''' <returns></returns>
        Friend Function AddInstanceParameterToCategory(bic As BuiltInCategory, pName As String, grp As BuiltInParameterGroup, pType As ForgeTypeId, isVisible As Boolean) As Boolean
            'this will be deprecated ParameterType to SpecTypeId -bimologist
    ...
    End Function
        ...
        Private Function CreateSharedParameter(paramName As String, paramType As ForgeTypeId) As Boolean
