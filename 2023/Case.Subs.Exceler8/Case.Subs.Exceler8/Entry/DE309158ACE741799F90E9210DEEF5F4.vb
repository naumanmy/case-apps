  ...
  Public Class DE309158ACE741799F90E9210DEEF5F4
    ...
    Public Function Execute(ByVal commandData As ExternalCommandData,
      ...
      Try
        ...
        ' Version
        If Not commandData.Application.Application.VersionName.Contains("2023") Then

          Using td As New TaskDialog("Cannot Continue")
            With td
              .TitleAutoPrefix = False
              .MainInstruction = "Incompatible Revit Version"
              .MainContent = "This Add-In was built for Revit 2023, please contact CASE for assistance..."
              .Show()
            End With
          End Using
