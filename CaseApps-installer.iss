...
;BIMologist 2022 added
;REVIT 2022 ~~~~~~~~~~~~~~~~~~~
Source: "deploy\2022\*"; DestDir: "{#RevitFolder21}"; Excludes: "*.pdb,*.xml,*.config,*.addin,*.tmp"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: revit22
