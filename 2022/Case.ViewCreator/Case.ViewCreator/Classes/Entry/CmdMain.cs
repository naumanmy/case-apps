  ...
  public class CmdMain : IExternalCommand
  {
                            ...
                            ElementSet elements)
    {
      try
      {
        ...
        // Version
        if (!commandData.Application.Application.VersionName.Contains("2022"))
        {
          message = "This Add-In was built for Revit 2022, please contact CASE for assistance...";
